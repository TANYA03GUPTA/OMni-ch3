...
func getRSS(rw http.ResponseWriter, req *http.Request) {
	...
	if i % 1000 == 0 {
	outputSVG.Text(i/30,390,timeText,"text-anchor:middle;fontsize:10px;fill:#000000")
	}else if i % 4 == 0 {
...
func main() {
	...
	width = 1000
	height = 400
	feeds = append(feeds, Feed{index: 0, url:"https://groups.google.com/forum/feed/golangnuts/msgs/rss_v2_0.xml?num=50", status: 0, itemCount: 0,complete: false, itemsComplete: false})
	...
	feeds = append(feeds, Feed{index: 2, url:"https://groups.google.com/forum/feed/golangdev/msgs/rss_v2_0.xml?num=50", status: 0, itemCount: 0,complete: false, itemsComplete: false })
